...
var TerrestrisMiner = TerrestrisShip.extend({
   ...
   __construct: function(id, x, y){
       ...
       this.properties = {
            ...
            rotationSpeed: 50,
            advanceSpeed: 1,
            image: 'images/terrestris/miner.png',
            icon: 'images/terrestris/miner_menu.png',
            weapon: {
                life: 20,
                image: 'images/terrestris/weapon.png',
                advanceSpeed: 1,
                rotationSpeed: 2,
                range: 20,
                reloadTime: 60,
        ...
        this.menu = [
          {
              slot: '#menu_slot_01',
              icon: 'images/terrestris/commandcenter.png',
   ...
   findNearestDepositPoint: function(){
       this.depositPoint = this.findNearest('.terrestris.mainbuilding.' + this.getSide().name);
   },
   ...
   processGather: function(order){
       ...
       // If the miner has finished
           ...
           this.setSprite('images/terrestris/miner_full.png');
   ...
   processDeposit: function(order){
       if(order.target.getPosition().distanceFrom(this.getPosition()) > this.properties.deposit.range){
          ...
          this.setSprite('images/terrestris/miner.png');
   ...
   processPlaceCommandCenter: function(){
      this.processPlaceBuilding(TerrestrisDock, 300, 10000);
   }
